#!/bin/bash
# submit_fat_boi_prelim.sh — build a Model-Upload-ready pickle for the prelim model.
#
# Usage: ./submit_fat_boi_prelim.sh models/dynamic_ensemble_20260728_XXXXXX
...
DOWNLOAD_NAME="predict_${NUMERAI_MODEL_NAME}_prelim"
